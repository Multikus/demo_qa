...
from generator.generator import generated_person, generated_file, generated_file_base64_to_jpeg
    ...
    def click_random_check_box(self):
        ...
        while count != 0:
            ...
            if count > 0:
                ...
                break
        print("Im was here CLICK_random_check_box")
...
class WebTablePage(BasePage):
    ...
    def check_delete(self):
        text = self.element_is_present(self.locators.CHECK_ROW_NO_FOUND).text
        return text
...
class ButtonsPage(BasePage):
    ...
    def click_on_different_button(self,  type_click):
        if type_click == 'double':
            ...
            output_text = self.check_clicked_on_the_button(self.locators.SUCCESS_DOUBLE)
            return output_text
...
class UploadAndDownloadPage(BasePage):
    ...
    def upload_file(self):
        ...
        os.remove(path)
        upload_file_text = self.element_is_present(self.locators.UPLOADED_FILE).text
        return file_name, upload_file_text

    def download_file(self):
        link = self.element_is_present(self.locators.DOWNLOAD_FILE).get_attribute('href')
        link_decode = base64.b64decode(link)
        offset = link_decode.find(b'\xff\xd8')
        answer = generated_file_base64_to_jpeg(link_decode[offset:])
        return answer
...
class DynamicPropertiesPage(BasePage):
    ...
    def check_appears_of_button(self):
        try:
            appears_button = self.element_is_visible(self.locators.VISIBLE_AFTER_BUTTON)
        except TimeoutException:
            return False
        return True

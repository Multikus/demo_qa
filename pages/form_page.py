...
from generator.generator import generated_person, generated_file, random_item_subjects
...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        ...
        self.remove_element(self.locators.FIX_BAN)
        ...
        self.element_is_visible(self.locators.SUBJECT).send_keys(random_item_subjects())

...
class AutoCompletePageLocators:
    ...
    VALUE_MULTIPLE_TEXT = (By. CSS_SELECTOR, 'div[class="css-1rhbuit-multiValue auto-complete__multi-value"]')
    DELETE_MULTIPLE_VALUE = (By. CSS_SELECTOR, 'div[class="css-1rhbuit-multiValue auto-complete__multi-value"] svg path')
    ALL_DELETE_MULTIPLE_VALUE = (By. CSS_SELECTOR, 'div[class="auto-complete__indicators css-1wy0on6"] div svg path')
    SINGLE_CONTAINER = (By. CSS_SELECTOR, 'div[id="autoCompleteSingleContainer"] div div div')
...
class ToolTipsPageLocators:
    ...
    BUTTON_HOVER_TOOLTIP = (By. CSS_SELECTOR, "button[aria-describedby='buttonToolTip']")
    INPUT = (By. CSS_SELECTOR, 'input[id="toolTipTextField"]')
    INPUT_HOVER_TOOLTIP = (By. CSS_SELECTOR, 'input[aria-describedby="textFieldToolTip"]')
...
class MenuPageLocators:
    MENU_ITEM_LIST = (By. CSS_SELECTOR, 'ul[id="nav"] a')

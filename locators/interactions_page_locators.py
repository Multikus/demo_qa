...
class DroppablePageLocators:
    ...
    DRAG_ME_SIMPLE = (By.CSS_SELECTOR, 'div[id="draggable"]')  # перетаскиваемый элемент
    DROP_HERE_SIMPLE = (By.CSS_SELECTOR, '#simpleDropContainer #droppable')  # поле куда перетаскиваем
...
class DraggablePageLocators:
    ...
    CONTAINER_WRAPPER = (By. CSS_SELECTOR, 'div[id="containmentWrapper"]')
